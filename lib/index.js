...
var SimpleExpressions = /** @class */ (function () {
    function SimpleExpressions() {
    }
    SimpleExpressions.logVerbose = function (message, key, data) {
    ...
    SimpleExpressions.verbose = function (value) {
        if (value === undefined) {
    ...
    SimpleExpressions._verboseLogging = false;
