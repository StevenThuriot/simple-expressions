...
exports.parseExpression = (function () {
    ...
    var parseLength = function (value) {
        var inner = parseSingleBody(value);
    ...
    var parseRegex = function (value) {
        var parameters = resolveParameters(value);
        return function (model) { return evaluateRegex(parameters.left(model), parameters.right(model)); };
    };
    var parseConcat = function (value) {
        var parameters = resolveParameters(value);
        return function (model) { return concat(parameters.left(model), parameters.right(model)); };
    };
